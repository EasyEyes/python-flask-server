...
def test_run():
    ...
    for i in range(num_captured):
        sig = readCSVData(f'/Users/ritikamotwani/easyeyes/python-flask-server/recordedMLSignal_{i}.csv')
    ...
    saveBufferToCSV(ir.real, '/Users/ritikamotwani/easyeyes/python-flask-server/ir_py.csv')
